...
<div class="space-y-6" x-data="{ editModal: false, activeFlag: {} }">
    ...
    <div x-show="editModal" style="display: none;" 
        ...
        <!-- Backdrop -->
        <div x-show="editModal" x-transition.opacity class="fixed inset-0 bg-black/80" @click="editModal = false"></div>
        <div @click.away="editModal = false" class="relative z-10 bg-slate-900 border border-slate-700 rounded-2xl max-w-md w-full p-6 shadow-2xl my-8">
